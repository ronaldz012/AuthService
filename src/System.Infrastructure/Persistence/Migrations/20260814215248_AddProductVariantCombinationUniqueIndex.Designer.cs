...
namespace System.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260814215248_AddProductVariantCombinationUniqueIndex")]
    partial class AddProductVariantCombinationUniqueIndex
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Module.Inventory.Domain.Products.ProductVariant", b =>
                {
                    ...
                    b.HasIndex("TenantId", "ProductId", "ColorId", "SizeId")
                        .IsUnique()
                        .HasFilter("\"DeletedAt\" IS NULL");
            ...
            modelBuilder.Entity("Module.Inventory.Domain.Products.Size", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Module.Inventory.Domain.Products.ProductVariant", b =>
                {
                    ...
                    b.HasOne("Module.Inventory.Domain.Products.Size", "Size")
                        .WithMany("ProductVariants")
