...
public static class RevertStockReceptionErrors
{
    ...
    public static readonly Error ContaminatedBySalesOrAdjustments = new(ErrorCode.Conflict, "Cannot revert reception because one or more variants have sales or adjustments after the reception");
