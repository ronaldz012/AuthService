...
public record RegisterUseCases(OpenCashRegister OpenCashRegister, CloseCashRegister CloseCashRegister, GetCurrentRegister GetCurrentRegister, ListClosures ListClosures);
