...
namespace Inventory.Data.Persistence.Migrations
{
    ...
    [Migration("20260430013831_refactor_transfer_movements")]
    partial class refactor_transfer_movements
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Inventory.Data.Entities.Products.Brand", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2026, 4, 30, 1, 38, 30, 289, DateTimeKind.Utc).AddTicks(3970),
                            Description = "",
                            Name = "Sin Marca"
                        });
                });
            ...
            modelBuilder.Entity("Inventory.Data.Entities.Products.Category", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2026, 4, 30, 1, 38, 30, 289, DateTimeKind.Utc).AddTicks(3867),
                            Description = "",
                            Name = "Sin categoria",
                            ParentId = 0
                        });
